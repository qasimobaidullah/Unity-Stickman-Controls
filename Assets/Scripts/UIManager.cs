...
public class UIManager : MonoBehaviour {
    ...
    void Start() {
        ...
        mainUI.transform.Find("Score").GetComponent<Text>().text = "best score: " + PlayerPrefs.GetInt("bestScore", 0);
    }
    ...
    public void play() {
		...
		playerMovement1.gameObject.transform.GetChild(0).transform.GetComponent<Animator>().SetTrigger("isRun");
		playerMovement2.gameObject.transform.GetChild(0).transform.GetComponent<Animator>().SetTrigger("isRun");
    ...
    public void restart() {
        ...
        playerMovement1.up = true; // Player 1 starts on the upper line
        playerMovement2.up = false; // Player 2 starts on the lower line
        ...
        mainUI.transform.Find("Score").GetComponent<Text>().text = "best score: " + PlayerPrefs.GetInt("bestScore", 0); // Update best score text
